    ...
    <AnimatePresence>
      ...
      >
        <motion.div
          ...
          className="w-full max-w-3xl bg-[var(--color-surface-card)] rounded-[var(--radius-lg)] border border-[var(--color-border-hairline)] shadow-2xl overflow-hidden flex flex-col max-h-[90vh]"
        >
          {/* Header */}
          <div className="flex justify-between items-center p-6 border-b border-[var(--color-border-hairline)]">
          ...
          <div className="flex-1 overflow-y-auto p-6 md:p-8">
            <h2 className="text-2xl md:text-3xl font-sans tracking-tight text-[var(--color-primary)] mb-4">
              Welcome to the Showroom Front Desk Workspace
            </h2>
            <p className="text-[15px] text-[var(--color-primary)] opacity-80 leading-relaxed mb-8">
            ...
            <h3 className="text-lg font-sans font-semibold text-[var(--color-primary)] mb-4">
            ...
            <h3 className="text-sm font-semibold tracking-wider text-[var(--color-muted)] uppercase mb-3">
              Financial Impact of Capturing 1 Missed Call Per Week
            </h3>
            
            <div className="border border-[var(--color-border-hairline)] rounded-xl overflow-hidden mb-6">
            ...
            <p className="text-sm text-[var(--color-primary)] opacity-80 leading-relaxed italic bg-gray-50 border border-[var(--color-border-hairline)] p-4 rounded-lg">
          ...
          {/* Footer */}
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4 p-5 border-t border-[var(--color-border-hairline)] bg-gray-50/50">
            <label className="flex items-center gap-2 text-sm text-[var(--color-muted)] hover:text-[var(--color-primary)] cursor-pointer transition-colors select-none">
              <input
                type="checkbox"
                checked={hideFuture}
            ...
            <button
              onClick={handleClose}
              className="w-full sm:w-auto px-6 py-2.5 bg-[var(--color-primary)] hover:bg-black text-white text-sm font-semibold rounded-[var(--radius-md)] transition-colors shadow-sm"
            >
